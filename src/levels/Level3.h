...
static void initLevel3() {
    ...
    enemies[0] = makeEnemy(20 * TILE_SIZE, 19 * TILE_SIZE, false, 88, true, 45);
    enemies[1] = makeEnemy(25 * TILE_SIZE, 15 * TILE_SIZE, true, 96, true, 35);
    enemies[2] = makeEnemy(34 * TILE_SIZE, 9 * TILE_SIZE, false, 105, false, 0);
...
static void runGameLevel3() {
  ...
  // ====== Cập nhật enemy và đạn
            ...
            for (int i = 0; i < MAX_BULLETS; ++i)
                updateBulletWithTileCollision(bullets[i], isSolidTileLevel3);
  ...
  // ====== Bắn đạn
            ...
            updatePlayerBullets(playerBullets, MAX_PLAYER_BULLETS, enemies, MAX_ENEMIES, isSolidTileLevel3);
